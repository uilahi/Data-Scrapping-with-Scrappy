...
from demo_scrapy_project.items import remove_quotations
...
class BooksToScrap(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for book in response.selector.xpath('//li[@class ="col-xs-6 col-sm-4 col-md-3 col-lg-3"]'):
            ...
            price_filter=book.xpath(".//p[@class='price_color']/text()").extract_first()
            yield {
                'title ': book.xpath(".//h3/a/text()[1]").extract_first(),
                'price': remove_quotations(price_filter),
